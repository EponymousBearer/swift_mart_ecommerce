...
const DifferentFromOthers = () => {
  return (
    <section className="mt-28 relative">
      ...
      <div className="bg-[#fbfcff] h-[90%] lg:h-[94%] xl:h-[90%] w-full absolute top-36 lg:top-16 xl:top-24 -z-10"><h1 className="font-extrabold text-7xl lg:text-[6.875rem] leading-[110px] text-paragraph opacity-[0.08] w-full
      mt-40 ml-10 lg:mt-24 lg:ml-16 xl:mt-28 xl:ml-36 xl:w-1/3 z-10 justify-start">Different From Others</h1></div>
    </section>
  );
};
