...
export default function PromoSection() {
  return (
    <div className="py-20 md:px-0 px-6 relative overflow-hidden bg-white">
      <div className="sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40 ">
        <div className="relative mx-auto lg:max-w-7xl md:max-w-2xl md:px-8 px-4 sm:static sm:px-6 lg:px-16 ">
          <div className="sm:max-w-lg">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl ">
